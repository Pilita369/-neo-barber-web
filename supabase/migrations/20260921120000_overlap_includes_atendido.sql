-- Un turno "atendido" tambien ocupa su horario: evita reservar encima de un
-- turno ya realizado. Solo cambia la lista de estados del chequeo SLOT_TAKEN.
...
begin
  ...
  if exists (
    ...
    where professional_id = p_professional_id
      and date = p_date
      and status in ('pendiente', 'confirmado', 'atendido')
